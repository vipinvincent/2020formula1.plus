...
const IndexPage = () => (
  <Layout title='Formula1 Plus - Formula 1 Latest News, Insights, Live Grand Prix Updates, Schedule, Standings, Drivers, Teams, Results and much more...'>
    <div className='w-full h-screen flex flex-col items-center content-center justify-center px-4'>
      <div className='w-full h-full max-w-5xl rounded-md text-center text-black-70 my-6 mx-24 px-8 pb-4'>
              ...
              <svg
                ...
                <g
                  ...
                  <motion.g
                    ...
                    <motion.g
                      initial={{ x: 200, y: 155 }}
                      animate={{ x: 202, y: 155, rotate: -360 }}
                    ...
                    <motion.g
                      ...
                      animate={{ x: 1252, y: 156, rotate: -360 }}
                      transition={spinTransition}
                      id='rear-tyre'>
                      <circle
                        id='Oval-11'
