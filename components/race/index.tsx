          ...
          <table className='w-full table'>
            <thead>
              <tr className='bg-white-100'>
                ...
                <th className='pr-4 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider table-cell whitespace-nowrap'>
                  Pit
                </th>
              </tr>
            </thead>
            <tbody className='bg-white'>
              ...
              <tr className='odd:bg-gray-100 bg-white-100 border-b border-gray-200'>
                <td className='px-4 py-1 whitespace-nowrap text-left table-cell'>
                  6
                </td>
                <td className='px-4 py-1 whitespace-nowrap table-cell'>
                  <div className='flex items-center'>
                    <div className='text-sm leading-5 font-medium text-gray-900 mclaren'>
