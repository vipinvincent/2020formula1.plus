  ...
  return (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <div className='flex flex-col mb-9 flex-grow flex-no-wrap flex-shrink-0'>
        ...
        <div className='w-full grid sm:flex sm:flex-col justify-around py-0 bg-white-100 rounded-tl-xxl rounded-br-xxl shadow-xs mb-4'>
          <div className='align-middle min-w-full overflow-x-auto rounded-tl-xxl rounded-br-xl bg-white-100'>
