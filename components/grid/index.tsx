  ...
  return (
    <div className='flex flex-col mb-9 flex-grow flex-no-wrap flex-shrink-0'>
      <div className='text-base leading-6 font-semibold uppercase tracking-wider text-secondary-on text-left mb-1 px-2 '>
        Starting Grid - 2020 British GP
      </div>
      <div className='w-full grid sm:flex sm:flex-col justify-around py-0 bg-green-600 rounded-tl-xxl rounded-br-xxl shadow-xs mb-4'>
        <div className='align-middle min-w-full overflow-x-auto rounded-tl-xxl rounded-br-xl bg-green-600 px-8'>
          <div className='grid grid-cols-3 gap-4 pt-4 pb-4 bg-gray-700 border-l-8 border-r-8 border-white-100'>
            ...
            <div className='col-span-2 bg-transparent h-12 flex items-center justify-center ml-2 pl-2 rounded-tl-lg border-l-2 border-t-2 border-white-100'>
            ...
            <div className='col-span-1 bg-transparent h-12 flex items-center justify-center'></div>
            <div className='col-span-2 bg-transparent h-12 flex items-center justify-center mr-2 pl-2 rounded-tl-lg border-l-2 border-t-2 border-white-100'>
              <div className='flex-shrink-0 flex items-center justify-center w-8 bg-mercedes p-2 text-white-100 text-sm leading-5 font-medium rounded-tl-lg rounded-br-lg'>
                2
              </div>
              <div className='flex-1 flex items-center justify-between'>
            ...
            <div className='col-span-2 bg-transparent h-12 flex items-center justify-center ml-2 pl-2 rounded-tl-lg border-l-2 border-t-2 border-white-100'>
              ...
              <div className='flex-1 flex items-center justify-between'>
                <div className='flex-1 px-2 py-2 text-sm leading-tight'>
                  <p className='text-white-100 uppercase'>Hulkenberg</p>
                </div>
              </div>
            </div>
            <div className='col-span-1 bg-transparent h-12 flex items-center justify-center'></div>
            ...
            <div className='col-span-2 bg-transparent h-12 flex items-center justify-center ml-2 pl-2 rounded-tl-lg border-l-2 border-t-2 border-white-100'>
              <div className='flex-shrink-0 flex items-center justify-center w-8 bg-aifaromeo p-2 text-white-100 text-sm leading-5 font-medium rounded-tl-lg rounded-br-lg'>
                15
              </div>
              <div className='flex-1 flex items-center justify-between'>
                <div className='flex-1 px-2 py-2 text-sm leading-tight'>
