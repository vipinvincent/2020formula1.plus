          ...
          <div className='flex flex-col justify-between bg-white-100 overflow-hidden  rounded-md border border-gray-100'>
              ...
              <div className='flex flex-row bg-white-100 items-center'>
                <div className='h-32 sm:h-40 w-full lg:w-1/3 text-center bg-white-100 '>
                  <img
                    ...
                    src='https://res.cloudinary.com/f1plus/image/upload/v1617084697/contentImages/drivers/2020/raikkonen_rttwsl.jpg'
                    alt='Kimi Räikkönen'
                  />
                </div>
            ...
            <div className='bg-gray-100 px-4 py-4 sm:px-6 aifaromeo'>
              <div className='flex items-center justify-center'>
                <div className='flex-shrink-0 bg-alfaromeo text-xl font-black text-white-100 rounded-md py-2 px-4 w-16 h-12'>
                  7
                </div>
            ...
            <div className='px-0'>
              <div className='flex flex-row bg-white-100 items-center'>
                <div className='h-32 sm:h-40 w-full lg:w-1/3 text-center bg-white-100 '>
                  <img
                    className='w-full h-full object-contain rounded-t-md rounded-b-md text-center'
                    src='https://res.cloudinary.com/f1plus/image/upload/v1617084696/contentImages/drivers/2020/giovinazzi_q3kefn.jpg'
