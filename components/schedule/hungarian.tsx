    ...
    <div className='flex flex-col mb-4'>
      ...
      <div className='relative bg-white-100 rounded-md'>
        <div className='h-32 sm:h-40 w-full text-center'>
          <img
            className='w-full h-full object-contain rounded-t-md rounded-b-md pt-4 text-center'
        ...
        <div className='relative max-w-screen-xl mx-auto'>
          <div className='py-4 text-left px-4'>
            ...
            <p className='mt-1 text-base leading-normal text-gray-700'>
              2020 Hungarian Grand Prix takes place over 70 laps of the 4.381km
              Hungaroring in Budapest on Sunday, July 19 2020
            </p>
          </div>
