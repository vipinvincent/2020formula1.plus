            ...
            <tbody className='bg-white'>
              <tr className='odd:bg-gray-100 bg-white-100'>
                ...
                <td className='p-4 whitespace-no-wrap border-b border-gray-200 table-cell text-right mercedes'>
                  <span className='px-2 inline-flex text-base leading-5 font-semibold rounded-tl-xl rounded-br-xl-full bg-gray-100 text'>
                    {' '}
                    0 ( 413 )
                  </span>
                </td>
              ...
              <tr className='odd:bg-gray-100 bg-white-100'>
                ...
                <td className='p-4 whitespace-no-wrap border-b border-gray-200 table-cell text-right renault'>
                  <span className='px-2 inline-flex text-base leading-5 font-semibold rounded-tl-xl rounded-br-xl-full bg-gray-100 text three-d-text'>
                    {' '}
                    0 ( 54 )
                  </span>
                </td>
