  ...
  datasets: [
    {
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [12, 37, 63, 88, 107, 132, 157, 164, 190, 205],
    },
    {
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [25, 43, 58, 58, 73, 89, 107, 117, 135, 161],
    },
    {
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [0, 15, 33, 52, 77, 95, 110, 110, 110, 128],
    },
    {
      label: '  Alex Albon',
      fill: false,
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [0, 12, 22, 26, 36, 40, 48, 48, 63, 64],
    },
    {
      label: ' Lando Norris',
      fill: false,
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [16, 26, 26, 36, 38, 39, 45, 57, 65, 65],
    },
    {
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [10, 13, 15, 15, 15, 23, 23, 41, 41, 41],
    },
    {
      label: ' Sergio Perez',
      fill: false,
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [8, 16, 22, 22, 22, 32, 33, 34, 44, 56],
    },
    {
      label: ' Lance Stroll',
      fill: false,
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [0, 6, 18, 20, 28, 40, 42, 57, 57, 57],
    },
    // {
    ...
    // },
    {
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [18, 18, 18, 33, 45, 45, 45, 45, 49, 57],
    },
    {
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [1, 1, 9, 10, 10, 16, 16, 16, 17, 17],
    },
    {
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [0, 4, 8, 20, 20, 20, 33, 41, 53, 63],
    },
    {
      label: ' Esteban Ocon',
      fill: false,
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [4, 4, 4, 12, 16, 16, 26, 30, 30, 36],
    },
    {
      label: ' Pierre Gasly',
      fill: false,
      ...
      pointRadius: 3,
      pointHitRadius: 10,
      data: [6, 6, 6, 12, 12, 14, 18, 43, 43, 45],
    },
    {
      label: ' Daniil Kvyat',
      fill: false,
