              ...
              <table className='min-w-full'>
                ...
                <tbody className='bg-white'>
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right mercedes'>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right redbull'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        319
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right mclaren'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        202
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right racingpoint'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        195
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right renault'>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right ferrari'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        131
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right alphatauri'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        107
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right alfaromeo'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        8
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right haas'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        3
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap border-b border-gray-200 text-right williams'>
                      <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text'>
                        0
                      </span>
                    </td>
