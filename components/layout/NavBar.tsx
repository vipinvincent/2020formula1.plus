...
const NavBar: React.FunctionComponent = () => (
  <nav className='w-full mx-auto flex justify-center container'>
    <div className='w-full flex flex-row justify-between h-12 bg-white-90'>
      <a
        href='/news'
        className='bg-white-10 hover:bg-white-100 inline-block border border-b-0 border-l-0 border-gray-200'>
      ...
      <a
        ...
        className='bg-white-10 hover:bg-white-100 inline-block border border-b-0 border-l-0 border-r-0 border-gray-200'>
        <div className='h-32 py-2 flex flex-col ferrari'>
          <div className='flex'>
            <Circuit />
          </div>
